...
export default  function Profile() {
  ...
  return (
    <>
    <section className='max-w-9xl max-auto flex justify-center items-center flex-col '>
      ...
      <div 
        ...
        <button type='submit' className='w-full bg-blue-600 text-white uppercase px-7 py-3 text-sm
                font-medium rounded shadow-md hover:bg-blue-700 transition duration-200 ease-in-out

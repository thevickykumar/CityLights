              ...
              <p className='text-lg mt-6 font-semibold'>
                ...
                <div className='flex'>
                  <button type='button' id='type' value='sale'
                     onClick={onChange} className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md
                         rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150
                          ease-in-out w-full ${type==='rent' ? 'bg-white text-black' : 'bg-slate-600 text-white'}`}>
                            Sell
                  </button>
                  <button type='button' id='type' value='rent'
                     onClick={onChange} className={`ml-3 px-7 py-3 font-medium text-sm uppercase shadow-md
                         rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150
                 ...
                 <div className='flex space-x-6 mb-6'>
                    <div>
                       ...
                       <input type="number" id="bedrooms" value={bedrooms}
                        ...
                        className='w-full px-4 py-2 text-xl text-gray-300 bg-white border border-gray-300 
                        rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white
                ...
                <div className='flex'>
                  <button type='button' id='offer' value={true}
                     onClick={onChange} className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md
                         rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150
                          ease-in-out w-full mb-6 ${!offer ? 'bg-white text-black' : 'bg-slate-600 text-white'}`}>
                            Yes
                  </button>
                ...
                <div className='flex items-center mb-6'>
                     <div>
                        ...
                        <div className='flex w-full justify-center items-center space-x-6'>
                            ...
                            onChange={onChange} min="4000" max="50000000000" required
                            className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 
                            rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white
                             focus:border-slate-600 text-center'
                            />
                ...
                {offer && (
                     ...
                     <div>
                        ...
                        <div className='flex w-full justify-center items-center space-x-6'>
                            ...
                            onChange={onChange} min="4000" max="50000000000" required={offer}
                            className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 
                            rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white
                             focus:border-slate-600 text-center'
                            />

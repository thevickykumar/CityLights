  ...
  return (
    <div className='bg-white border-b shadow-sm sticky top-0 z-40'>
        <header className='flex justify-between items-center px-3 max-w-6xl mx-auto'>
            <div>
                <img src='https://citylightcorp.com/wp-content/uploads/2020/04/CL_LOGO-removebg-preview-copy-copy.png' 
                          alt='logo' className='h-16 cursor-pointer'
                           onClick={() => navigate('/')}/>
                          </div>
                          <div>
                          <ul className='flex space-x-10'>
                            ...
                            <li
                               className={`cursor-pointer py-3 text-sm font-semibold text-gray-400 border-b-[3px] 
                             border-b-transparent ${(pathMathRoute('/sign-in') || pathMathRoute('/profile')) && 
